...
<head>
    ...
    <xml>
        <x:ExcelWorkbook>
            <x:ExcelWorksheets>
                <x:ExcelWorksheet>
                    <x:Name>Property Inventory</x:Name>
                    <x:WorksheetOptions>
                        <x:DisplayGridlines/>
                        <x:PageSetup><x:Layout x:Orientation="Landscape"/><x:PaperSizeIndex>9</x:PaperSizeIndex></x:PageSetup>
                    </x:WorksheetOptions>
                </x:ExcelWorksheet>
            </x:ExcelWorksheets>
        </x:ExcelWorkbook>
...
<body>
    <table>
        <tr><td colspan="10" class="no-border" style="font-size:14pt; font-weight:bold; text-align:center;">PROPERTY MANAGEMENT INFORMATION SYSTEM</td></tr>
        <tr><td colspan="10" class="no-border" style="text-align:center;">Property Inventory Report</td></tr>
        <tr><td colspan="10" class="no-border" style="text-align:center;">Generated: <?= date("F j, Y | h:i A") ?></td></tr>
        ...
        <tr>
            ...
            <th>NEW PROPERTY NO. ASSIGNED (For Validation)</th>
        ...
        <?php if ($rows && $rows->num_rows > 0): ?>
            ...
            <?php endwhile; ?>
        <?php else: ?>
            <tr><td colspan="10" style="text-align:center;">No property records found.</td></tr>
        <?php endif; ?>
        ...
        <!-- Signatures -->
        <tr style="height:30px;"><td colspan="10" class="no-border"></td></tr>
        <tr>
            <td colspan="4" class="no-border">Prepared by:</td>
            <td colspan="2" class="no-border"></td>
            <td colspan="4" class="no-border">Approved by:</td>
        </tr>
        <tr style="height:45px;"><td colspan="10" class="no-border"></td></tr>
        <tr>
            <td colspan="4" class="no-border"><strong>ALVIN RAY S. BAWAR</strong><br>Property Custodian</td>
            <td colspan="2" class="no-border"></td>
            <td colspan="4" class="no-border"><strong>JONATHAN R. DIGMA, Ph.D.</strong><br>Campus Administrator</td>
        </tr>
    </table>
</body>
</html>